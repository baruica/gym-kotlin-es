...
class Send3YearsAnniversaryThankYouEmailsTest {
    ...
    fun handle() {
        ...
        assertTrue(events.contains(ThreeYearsAnniversaryThankYouEmailSent(memberJulie.memberId.toString(), startDateJulie.toString())))

        assertFalse(mailer.sentEmails.containsValue("Thank you for your loyalty bob@gmail.com !"))
        assertFalse(events.contains(ThreeYearsAnniversaryThankYouEmailSent(memberBob.memberId.toString(), startDateBob.toString())))

        assertTrue(mailer.sentEmails.containsValue("Thank you for your loyalty luke@gmail.com !"))
        assertTrue(events.contains(ThreeYearsAnniversaryThankYouEmailSent(memberLuke.memberId.toString(), startDateLuke.toString())))
    }
