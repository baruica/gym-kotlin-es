...
dependencies {
    ...
    testImplementation("io.kotest:kotest-assertions-shared:6.2.1")
    testImplementation("io.kotest:kotest-common:6.2.1")
    testImplementation("io.kotest:kotest-framework-api:6.2.1")
}
