...
dependencies {
    ...
    testImplementation("io.kotest:kotest-assertions-shared:6.1.3")
    testImplementation("io.kotest:kotest-common:6.1.3")
    testImplementation("io.kotest:kotest-framework-api:6.1.3")
}
